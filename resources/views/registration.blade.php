...
@section('content')
    <div class="mt-5 container w-25">
        <form action="{{ route('user.registration-store') }}" method="post">
            ...
            <h1 class="h3 my-5 fw-normal">Please registrate</h1>
            
            <div class="form-floating">
                <input name="name" type="text" class="form-control" id="floatingInput" placeholder="Username">
            ...
            <div class="form-floating mt-3"><a class="link-secondary" href="{{ route('user.login') }}">Have an account? register!</a></div>
